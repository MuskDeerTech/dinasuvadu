...
export default function Header({ categories }: HeaderProps) {
  ...
  // Define the fixed category titles and their default slugs with parents where needed
  const fixedCategories = [
    { title: "Home", slug: "/", id: "home" },
    { title: "தமிழ்நாடு", slug: "tamilnadu", id: "cat-tamilnadu", parent: { slug: "news", title: "News" } },
    { title: "இந்தியா", slug: "india", id: "cat-india", parent: { slug: "news", title: "News" } },
  ...
  const sortedCategories = fixedCategories.map((fixedCategory) => {
    ...
    if (categoryFromProp) {
      ...
      return { ...fixedCategory, parent: fixedCategory.parent || undefined };
    }
  });
