...
export default async function SubCategoryPostPage({
  ...
  params: Promise<{ categorySlug: string; postSlug: string; subPostSlug: string }>;
}) {
  console.log("Entering SubCategoryPostPage component for [categorySlug]/[postSlug]/[subPostSlug]");
  ...
  if (!postCategory) {
    console.log(`Post ${subPostSlug} has no associated category, using default`);
  ...
  <div className="d-flex gap al-cn social-media-icon fl-wrap-mob">
    {/* WhatsApp Share */}
    <a
      href={`https://api.whatsapp.com/send?text=${encodeURIComponent(post.title)}%20${encodeURIComponent(`https://www.dinasuvadu.com/${categorySlug}/${postSlug}/${subPostSlug}`)}`}
      target="_blank"
    ...
    {/* Facebook Share */}
    <a
      href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://www.dinasuvadu.com/${categorySlug}/${postSlug}/${subPostSlug}`)}`}
      target="_blank"
      rel="noopener noreferrer"
    ...
    {/* Twitter (X) Share */}
    <a
      href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=${encodeURIComponent(`https://www.dinasuvadu.com/${categorySlug}/${postSlug}/${subPostSlug}`)}`}
      target="_blank"
      rel="noopener noreferrer"
      id="twitter-logo"
    ...
    {/* LinkedIn Share */}
    <a
      href={`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(`https://www.dinasuvadu.com/${categorySlug}/${postSlug}/${subPostSlug}`)}&title=${encodeURIComponent(post.title)}`}
      target="_blank"
      rel="noopener noreferrer"
              ...
              <div className="relative">
                {(() => {
                  ...
                  return imageUrl ? (
                    ...
                    <div
                      className="w-full h-64 sm:h-96 bg-gray-100 rounded-lg flex items-center justify-center"
                    >
...
export async function generateStaticParams() {
  console.log("Entering generateStaticParams for [categorySlug]/[postSlug]/[subPostSlug]");
